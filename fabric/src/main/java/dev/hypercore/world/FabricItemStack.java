...
/**
 * Fabric-aware {@link org.bukkit.inventory.ItemStack} that wraps a native
 ...
 */
public final class FabricItemStack extends org.bukkit.inventory.ItemStack {
    private net.minecraft.world.item.ItemStack mcStack;

    public FabricItemStack(net.minecraft.world.item.ItemStack mcStack) {
        super(FabricWorldAccess.toMaterial(mcStack.getItem()), mcStack.getCount());
        this.mcStack = Objects.requireNonNull(mcStack, "mcStack");
    }

    @Override
    public Material getType() {
        return FabricWorldAccess.toMaterial(mcStack.getItem());
    }

    @Override
    public void setType(Material type) {
        super.setType(type);
        net.minecraft.world.item.Item replacement = FabricWorldAccess.toItem(type);
    ...
    @Override
    public FabricItemStack clone() {
        return new FabricItemStack(mcStack.copy());
    }
}
