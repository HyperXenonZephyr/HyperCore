...
/**
 * Fabric copy of the {@code /hypercore} command tree.
 *
 * <p>Forge and Fabric both run Minecraft with Mojang (official) mappings, so the
 * brigadier / {@code CommandSourceStack} / {@code Component} symbols are
 * identical. The command body only touches loader-agnostic core types, so this
 * is a verbatim port of the Forge command class with the entry-point reference
 * swapped to {@link HyperCoreFabric}. It is intentionally not abstracted into
 * core to keep core free of Minecraft dependencies.
 */
public final class HyperCoreCommands {
    ...
    private static int showStatus(CommandSourceStack source, HyperCoreRuntime runtime) {
        ...
        source.sendSuccess(() -> Component.literal(
            "HyperCore " + HyperCoreFabric.VERSION
