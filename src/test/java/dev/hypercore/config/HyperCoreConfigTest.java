...
class HyperCoreConfigTest {
    ...
    void resolvesAutomaticWorkerAndQueueValues() {
        HyperCoreConfig.Settings settings = new HyperCoreConfig.Settings(0, 0, 200, false, false, 16_384);
    ...
    void preservesExplicitWorkerAndQueueValues() {
        HyperCoreConfig.Settings settings = new HyperCoreConfig.Settings(4, 512, 400, true, true, 32_768);
    ...
    void rejectsInvalidSettings() {
        assertThrows(
            ...
            () -> new HyperCoreConfig.Settings(-1, 128, 200, false, false, 16_384)
        );
        assertThrows(
            IllegalArgumentException.class,
            () -> new HyperCoreConfig.Settings(1, -1, 200, false, false, 16_384)
        );
        assertThrows(
            IllegalArgumentException.class,
            () -> new HyperCoreConfig.Settings(1, 128, 0, false, false, 16_384)
        );
        assertThrows(
            IllegalArgumentException.class,
            () -> new HyperCoreConfig.Settings(1, 128, 200, false, false, 0)
        );
    }
}
